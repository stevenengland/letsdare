...
DATABASES = {
    "default": {
        ...
        "NAME": config("DEPENDENCY_DJANGO_DB_NAME", default="letsdare"),
        "USER": config("DEPENDENCY_DJANGO_DB_USER", default="letsdare"),
        "PASSWORD": config("DEPENDENCY_DJANGO_DB_PASSWORD", default="letsdare"),
